...
class NeveLudensTokenizerConfig(BaseModel):
    tokenizer_id: Literal['neveludens'] = Field(default='neveludens', frozen=True)
...
class NeveLudensTokenizer(Tokenizer):
    """
    ...
    def __init__(self, config: NeveLudensTokenizerConfig):
