...
class NeveLudens_Config(BaseModel):
    model_type: str = Field(default="neveludens", frozen=True)
    ...
    @classmethod
    def from_yaml(cls, yaml_path: str | Path) -> "NeveLudens_Config":
...
class NeveLudens(torch.nn.Module):
    config_class = NeveLudens_Config
    supports_gradient_checkpointing = True

    def __init__(
        self,
        config: NeveLudens_Config,
