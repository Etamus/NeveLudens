...
from neveludens.flow_matching_transformer.neveludens import NeveLudens_Config
from neveludens.mm_tokenizers import NeveLudensTokenizerConfig
...
class CkptConfig(BaseModel):
    ...
    model_cfg: NeveLudens_Config = Field(..., description="Model configuration. This is a placeholder and should be replaced with the actual model config class.")
    tokenizer_cfg: NeveLudensTokenizerConfig = Field(..., description="Tokenizer configuration. This is a placeholder and should be replaced with the actual tokenizer config class.")
